...
if __name__ == '__main__':
     ...
     net=nn.Sequential(nn.Flatten(),nn.Linear(num_input,num_H1),nn.Dropout(0.5),nn.ReLU(),nn.Linear(num_H1,num_H2),nn.ReLU(),nn.Dropout(0.4),nn.Linear(num_H2,num_H3),nn.ReLU(),nn.Dropout(0.5),nn.Linear(num_H3,num_output))
